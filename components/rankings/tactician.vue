...
<template>
  <div v-if="!loading">
    ...
    >
      ...
      >
        <p class="w-[25%]"></p>
        <p class="w-[75%] text-left">Tacticians of Legend</p>
      </div>
      <!-- Tacticians of Legend   -->
      <div
      ...
      >
        <p class="w-[25%]"></p>
        <p class="w-[75%] text-left">Tacticians of Valour</p>
      </div>
      <!-- Tacticians of Valour  -->
      <div
      ...
      >
        <p class="w-[25%]"></p>
        <p class="w-[75%] text-left">Tacticians of Fortitude</p>
        <p class=""></p>
      </div>
